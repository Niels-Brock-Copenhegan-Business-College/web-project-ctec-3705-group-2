...
class ProgrammeModule
{
    ...
    private function makeSlug(string $t): string { return strtolower(str_replace(' ','-',$t)); // TODO: improve slug generation }
    public function count(): int { return 0; // TODO: implement count query }
    public function countPublished(): int { return 0; // TODO: implement count query }
}
